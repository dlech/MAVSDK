...
public:
    ...
    grpc::Status SubscribeTakePhoto(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeTakePhotoRequest* /* request */, grpc::ServerWriter<rpc::camera_server::TakePhotoResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin()->subscribe_take_photo(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex](mavsdk::CameraServer::Result result,const int32_t take_photo) {
        ...
        rpc::camera_server::PublishPhotoResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_photo(translateFromRpcCaptureInfo(request->capture_info()));
