...
template<typename T> inline const std::string& AsyncType_Name(T enum_t_value)
{
    static_assert(
        ::std::is_same<T, AsyncType>::value || ::std::is_integral<T>::value,
        "Incorrect type passed to function AsyncType_Name.");
    return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(AsyncType_descriptor(), enum_t_value);
}
inline bool AsyncType_Parse(const std::string& name, AsyncType* value)
{
...
extern ::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier<
    ::google::protobuf::FieldOptions,
    ::PROTOBUF_NAMESPACE_ID::internal::PrimitiveTypeTraits<double>,
    1,
    false>
    epsilon;
...
extern ::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier<
    ::google::protobuf::MethodOptions,
    ::PROTOBUF_NAMESPACE_ID::internal::PrimitiveTypeTraits<bool>,
    8,
    false>
    is_finite;
