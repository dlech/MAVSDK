...
public:
    ...
    template<class BaseClass> class ExperimentalWithCallbackMethod_PlayTune : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    public:
        ...
        void SetMessageAllocatorFor_PlayTune(::grpc::experimental::MessageAllocator<
                                             ::mavsdk::rpc::tune::PlayTuneRequest,
    ...
    template<class BaseClass> class ExperimentalWithRawCallbackMethod_PlayTune : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
