...
PROTOBUF_NAMESPACE_OPEN
template<>
::mavsdk::rpc::core::ConnectionState*
Arena::CreateMaybeMessage<::mavsdk::rpc::core::ConnectionState>(Arena*);
template<>
::mavsdk::rpc::core::ConnectionStateResponse*
Arena::CreateMaybeMessage<::mavsdk::rpc::core::ConnectionStateResponse>(Arena*);
template<>
::mavsdk::rpc::core::SetMavlinkTimeoutRequest*
Arena::CreateMaybeMessage<::mavsdk::rpc::core::SetMavlinkTimeoutRequest>(Arena*);
template<>
::mavsdk::rpc::core::SetMavlinkTimeoutResponse*
Arena::CreateMaybeMessage<::mavsdk::rpc::core::SetMavlinkTimeoutResponse>(Arena*);
template<>
::mavsdk::rpc::core::SubscribeConnectionStateRequest*
Arena::CreateMaybeMessage<::mavsdk::rpc::core::SubscribeConnectionStateRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace mavsdk {
namespace rpc {
namespace core {
...
class SubscribeConnectionStateRequest PROTOBUF_FINAL : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mavsdk.rpc.core.SubscribeConnectionStateRequest)
                                                                                                */
{
public:
...
class ConnectionStateResponse PROTOBUF_FINAL : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mavsdk.rpc.core.ConnectionStateResponse)
                                                                                        */
{
public:
...
class SetMavlinkTimeoutRequest PROTOBUF_FINAL : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mavsdk.rpc.core.SetMavlinkTimeoutRequest)
                                                                                         */
{
public:
...
class SetMavlinkTimeoutResponse PROTOBUF_FINAL : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mavsdk.rpc.core.SetMavlinkTimeoutResponse)
                                                                                          */
{
public:
...
{
    auto temp = unsafe_arena_release_connection_state();
    if (GetArena() != nullptr) {
...
inline void ConnectionStateResponse::set_allocated_connection_state(
    ::mavsdk::rpc::core::ConnectionState* connection_state)
{
