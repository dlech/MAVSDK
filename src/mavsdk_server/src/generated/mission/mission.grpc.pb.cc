...
MissionService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_SubscribeUploadMissionWithProgress_(MissionService_method_names[1], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_CancelMissionUpload_(MissionService_method_names[2], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DownloadMission_(MissionService_method_names[3], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SubscribeDownloadMissionWithProgress_(MissionService_method_names[4], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_CancelMissionDownload_(MissionService_method_names[5], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_StartMission_(MissionService_method_names[6], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_PauseMission_(MissionService_method_names[7], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ClearMission_(MissionService_method_names[8], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SetCurrentMissionItem_(MissionService_method_names[9], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_IsMissionFinished_(MissionService_method_names[10], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SubscribeMissionProgress_(MissionService_method_names[11], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_GetReturnToLaunchAfterMission_(MissionService_method_names[12], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SetReturnToLaunchAfterMission_(MissionService_method_names[13], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::ClientReader< ::mavsdk::rpc::mission::UploadMissionWithProgressResponse>* MissionService::Stub::SubscribeUploadMissionWithProgressRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::mission::SubscribeUploadMissionWithProgressRequest& request) {
  return ::grpc_impl::internal::ClientReaderFactory< ::mavsdk::rpc::mission::UploadMissionWithProgressResponse>::Create(channel_.get(), rpcmethod_SubscribeUploadMissionWithProgress_, context, request);
}

void MissionService::Stub::experimental_async::SubscribeUploadMissionWithProgress(::grpc::ClientContext* context, ::mavsdk::rpc::mission::SubscribeUploadMissionWithProgressRequest* request, ::grpc::experimental::ClientReadReactor< ::mavsdk::rpc::mission::UploadMissionWithProgressResponse>* reactor) {
  ::grpc_impl::internal::ClientCallbackReaderFactory< ::mavsdk::rpc::mission::UploadMissionWithProgressResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_SubscribeUploadMissionWithProgress_, context, request, reactor);
}
...
::grpc::ClientAsyncReader< ::mavsdk::rpc::mission::UploadMissionWithProgressResponse>* MissionService::Stub::AsyncSubscribeUploadMissionWithProgressRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::mission::SubscribeUploadMissionWithProgressRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc_impl::internal::ClientAsyncReaderFactory< ::mavsdk::rpc::mission::UploadMissionWithProgressResponse>::Create(channel_.get(), cq, rpcmethod_SubscribeUploadMissionWithProgress_, context, request, true, tag);
}
...
::grpc::ClientAsyncReader< ::mavsdk::rpc::mission::UploadMissionWithProgressResponse>* MissionService::Stub::PrepareAsyncSubscribeUploadMissionWithProgressRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::mission::SubscribeUploadMissionWithProgressRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncReaderFactory< ::mavsdk::rpc::mission::UploadMissionWithProgressResponse>::Create(channel_.get(), cq, rpcmethod_SubscribeUploadMissionWithProgress_, context, request, false, nullptr);
}
...
::grpc::ClientReader< ::mavsdk::rpc::mission::DownloadMissionWithProgressResponse>* MissionService::Stub::SubscribeDownloadMissionWithProgressRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::mission::SubscribeDownloadMissionWithProgressRequest& request) {
  return ::grpc_impl::internal::ClientReaderFactory< ::mavsdk::rpc::mission::DownloadMissionWithProgressResponse>::Create(channel_.get(), rpcmethod_SubscribeDownloadMissionWithProgress_, context, request);
}

void MissionService::Stub::experimental_async::SubscribeDownloadMissionWithProgress(::grpc::ClientContext* context, ::mavsdk::rpc::mission::SubscribeDownloadMissionWithProgressRequest* request, ::grpc::experimental::ClientReadReactor< ::mavsdk::rpc::mission::DownloadMissionWithProgressResponse>* reactor) {
  ::grpc_impl::internal::ClientCallbackReaderFactory< ::mavsdk::rpc::mission::DownloadMissionWithProgressResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_SubscribeDownloadMissionWithProgress_, context, request, reactor);
}
...
::grpc::ClientAsyncReader< ::mavsdk::rpc::mission::DownloadMissionWithProgressResponse>* MissionService::Stub::AsyncSubscribeDownloadMissionWithProgressRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::mission::SubscribeDownloadMissionWithProgressRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc_impl::internal::ClientAsyncReaderFactory< ::mavsdk::rpc::mission::DownloadMissionWithProgressResponse>::Create(channel_.get(), cq, rpcmethod_SubscribeDownloadMissionWithProgress_, context, request, true, tag);
}
...
::grpc::ClientAsyncReader< ::mavsdk::rpc::mission::DownloadMissionWithProgressResponse>* MissionService::Stub::PrepareAsyncSubscribeDownloadMissionWithProgressRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::mission::SubscribeDownloadMissionWithProgressRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncReaderFactory< ::mavsdk::rpc::mission::DownloadMissionWithProgressResponse>::Create(channel_.get(), cq, rpcmethod_SubscribeDownloadMissionWithProgress_, context, request, false, nullptr);
}
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::ServerStreamingHandler< MissionService::Service, ::mavsdk::rpc::mission::SubscribeUploadMissionWithProgressRequest, ::mavsdk::rpc::mission::UploadMissionWithProgressResponse>(
          [](MissionService::Service* service,
             ...
             ::grpc_impl::ServerWriter<::mavsdk::rpc::mission::UploadMissionWithProgressResponse>* writer) {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::ServerStreamingHandler< MissionService::Service, ::mavsdk::rpc::mission::SubscribeDownloadMissionWithProgressRequest, ::mavsdk::rpc::mission::DownloadMissionWithProgressResponse>(
          [](MissionService::Service* service,
             ...
             ::grpc_impl::ServerWriter<::mavsdk::rpc::mission::DownloadMissionWithProgressResponse>* writer) {
